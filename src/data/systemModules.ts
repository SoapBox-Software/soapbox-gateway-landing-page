  ...
  "EHS": [
    {
      ...
      modules: [
        ...
        { title: "Incident Management", description: "Reports, tracks, investigates, and closes incidents with SLAs.", url: "https://id-preview--f99a2393-525e-4364-8eb2-acfffb59b793.lovable.app/", icon: AlertTriangle },
        ...
        { title: "Non-Compliance Reporting", description: "Track non-compliance events with corrective actions.", url: "https://id-preview--ccd53946-f109-4566-a565-91b8f33c7e49.lovable.app/", icon: FileWarning },
        { title: "Inspection", description: "Digital inspection forms and automated workflows.", url: "https://id-preview--55ff2edf-2392-4b5c-afa1-3aab46c0ae94.lovable.app/dashboard", icon: Search },
        { title: "Job Safety Analysis (JSA)", description: "Systematic evaluation of job tasks and safety.", url: "https://id-preview--9881f2cb-94db-4582-bc7e-db10024fa194.lovable.app/", icon: ClipboardList },
    ...
    },
    {
      ...
      modules: [
        ...
        { title: "Advanced Risk Management", description: "Predictive risk analytics and modeling.", icon: Target, url: "https://id-preview--aa830949-055e-4a47-95e6-9efe15c69314.lovable.app/" },
  ...
  "Asset Management": [
    {
      ...
      modules: [
        ...
        { title: "Maintenance Management / CMMS", description: "Preventive, predictive, and corrective maintenance.", url: "https://id-preview--dd7712e5-7e25-4e66-9ceb-96cdcd68adff.lovable.app/", icon: Wrench },
  ...
  "eQMS": [
    {
      ...
      modules: [
        ...
        { title: "Quality Risk Management", description: "Risk assessment for quality.", url: "https://id-preview--0cf9fdaf-35b2-44d4-9876-720e22c68604.lovable.app/", icon: Shield },
        ...
        { title: "SPC & Quality Analytics", description: "Statistical process control.", url: "https://id-preview--61eade73-ecc5-4342-abf7-ce215403125f.lovable.app/", icon: BarChart3 },
        { title: "KPI & Dashboards", description: "Performance dashboards.", url: "https://id-preview--3693cd7b-37bb-4f4f-b6a4-b6599daeeaed.lovable.app/", icon: PieChart },
        ...
        { title: "Supplier Qualification", description: "Supplier qualification workflow.", url: "https://id-preview--84d93c08-e212-4d92-a5b6-7535a236489d.lovable.app/", icon: UserCheck },
      ]
    },
    {
      title: "Advanced Modules",
