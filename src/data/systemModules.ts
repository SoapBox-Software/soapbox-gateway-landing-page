  ...
  "eQMS": [
    {
      ...
      modules: [
        ...
        { title: "Complaints & Feedback", description: "Customer feedback management.", icon: Megaphone, comingSoon: true },
        { title: "Supplier Quality", description: "Vendor quality management.", icon: Truck, comingSoon: true },
        { title: "Calibration & Equipment", description: "Equipment calibration tracking.", icon: Settings, comingSoon: true },
        { title: "Quality Inspections", description: "Product inspection and release.", icon: Search, comingSoon: true },
        { title: "Product Lifecycle Quality", description: "Quality across product lifecycle.", icon: Layers, comingSoon: true },
  ...
  "OHSM": [
    {
      ...
      modules: [
        ...
        { title: "Occupational Health", description: "Health monitoring.", icon: Stethoscope, comingSoon: true },
